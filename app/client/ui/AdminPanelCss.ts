 ...
 *
 * @param confirmed - observable controlling visibility
 * @param onEdit - callback when pencil is clicked (should reset confirmed)
 * @param options.skipped - if true, shows "Will do later" instead of "Confirmed"
